...
#include "ground.hpp"   // for the Ground class definition
#include "uiDraw.hpp"   // for random() and drawLine()
#include <cassert>
#include <iostream>
 ...
 if (iHowitzer < width / 2) {
   ...
   for (int i = 1; i < width; i++)
   {
      ...
      else
      {
         ...
         else if (ground[i] > posUpperRight.getPixelsY()) {
